...
add wave -noupdate -expand -group memInst -label sig_out_PC /mips_vhd_tst/i1/sig_out_PC
add wave -noupdate -expand -group memInst -label sig_OUT_memI_1 /mips_vhd_tst/i1/sig_OUT_memI_1
...
add wave -noupdate -expand -group {OUT PIPE 2} -label sig_ulaOp_1 /mips_vhd_tst/i1/sig_ulaOp_1
add wave -noupdate -expand -group {OUT PIPE 2} -label sig_RegDST_1 /mips_vhd_tst/i1/sig_RegDST_1
add wave -noupdate -expand -group {OUT PIPE 2} -label sig_ulaFonte_1 /mips_vhd_tst/i1/sig_ulaFonte_1
add wave -noupdate -expand -group {OUT PIPE 2} -label sig_escMem_1 /mips_vhd_tst/i1/sig_escMem_1
add wave -noupdate -expand -group {OUT PIPE 2} -label sig_lerMem_1 /mips_vhd_tst/i1/sig_lerMem_1
add wave -noupdate -expand -group {OUT PIPE 2} -label sig_DvC_1 /mips_vhd_tst/i1/sig_DvC_1
...
add wave -noupdate -expand -group {OUT PIPE 2} -label sig_function /mips_vhd_tst/i1/sig_function
