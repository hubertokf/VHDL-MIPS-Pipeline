...
add wave -noupdate -expand -group fontePC -label sig_DvC_2 /mips_vhd_tst/i1/sig_DvC_2
add wave -noupdate -expand -group fontePC -label sig_ULA_zero_1 /mips_vhd_tst/i1/sig_ULA_zero_1
add wave -noupdate -expand -group fontePC -label sig_fontePC /mips_vhd_tst/i1/sig_fontePC
add wave -noupdate -expand -group memData -label sig_ULA_result_1 /mips_vhd_tst/i1/sig_ULA_result_1
add wave -noupdate -expand -group memData -label sig_dadoLido2_2 /mips_vhd_tst/i1/sig_dadoLido2_2
add wave -noupdate -expand -group memData -label sig_escMem_2 /mips_vhd_tst/i1/sig_escMem_2
add wave -noupdate -expand -group memData -label sig_OUT_memD /mips_vhd_tst/i1/sig_OUT_memD
